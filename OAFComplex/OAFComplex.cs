...
namespace OAFComplex
{
    ...
    public class OAFComplex: IOAFComplex
    {
        ...
        private const string _userAgent = "speakeasy-sdk/csharp 0.2.0 2.192.1 1.0.0 OAF-Complex";
        ...
        public OAFComplex(int? serverIndex = null, string?  subUrl = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null)
        {
            if (serverUrl != null) {
                if (urlParams != null) {
